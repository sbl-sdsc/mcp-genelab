...
| File | What it guards |
|---|---|
| `test_tools_list.py` | All 21 tools register; every tool has title + readOnlyHint + idempotentHint + openWorldHint; titles are unique; the right tools are read-only vs. file-writing. |
